({
  renderIcon: function(component) {
    ...
    var dataRecId = component.get("v.data-recordId");
    ...
    svgroot.setAttribute("data-recordId",dataRecId);
    svgroot.setAttribute("id",component.get("v.Id"));
    ...
    shape.setAttribute("data-recordId",dataRecId);
