({
                    ...
                    action.setCallback(this, function(response) {    
                        ...
                        if (state === "SUCCESS") {
                            ...
                            if(OrderObj == null){
                                ...
                                component.set("v.orderFolioNumber", OrderObj.Folio_Number__c);
                                ...
                                if(OrderObj.Product_Type_Order_Entry__c == 'IPO'){
        ...
        if((orderEntry.Transaction_Type__c == 'Redemption' || orderEntry.Transaction_Type__c == 'Switch' || orderEntry.Transaction_Type__c == 'SWP' || orderEntry.Transaction_Type__c == 'STP') && isorderentrymf){
         ...
         /*   if((orderEntry.Transaction_Type__c == 'Purchase' || orderEntry.Transaction_Type__c == 'SIP') &&  isorderentrymf ){
                    ...
                    action.setCallback(this, function(response) {
                        ...
                        if (state === "SUCCESS") {
                            ...
                            if(clientAssetList == null){
                                ...
                                component.set("v.selectedFolioPMS", orderEntry.Folio__c);
                            }
                        }
                    });$A.enqueueAction(action); 
            ...
            helper.setFamilyNameController(component, event, helper);
             ...
             console.log('orderEntry.No_of_units__c :'+orderEntry.No_of_units__c);
             console.log('orderEntry.of_Facevalue__c :'+orderEntry.of_Facevalue__c);
             console.log('orderEntry.Price_new__c :'+orderEntry.Price_new__c);
             if(orderEntry.Transaction_Type__c == 'Equity IPO')
             {
                 component.set("v.isIPOBondPriceDisable",true);
             }
             if(orderEntry.Transaction_Type__c == 'Bond IPO')
             {
                 if(orderEntry.Transaction_Amount_Financial_Transaction__c == '' || typeof orderEntry.Transaction_Amount_Financial_Transaction__c == 'undefined')
                 {
                     component.set("v.isIPOBondAmountDisable",true); 
                     
                 }
                 if(orderEntry.No_of_units__c == '' || typeof orderEntry.No_of_units__c == 'undefined')
                 {
                     component.set("v.isIPOBondUnitDisable",true);
                 }
                 if(orderEntry.of_Facevalue__c == '' || typeof orderEntry.of_Facevalue__c == 'undefined')
                 {
                     component.set("v.isIPOBondFaceValueDisable",true);
                     
                 }
                 if(orderEntry.Price_new__c == '' || typeof orderEntry.Price_new__c == 'undefined')
                 {
                     component.set("v.isIPOBondPriceDisable",true);
                 }
             }
    ...
    */
    ...
    setValuesToIPOField : function(component, event, helper){
        debugger;
		 var orderEntry = component.get("v.orderEntry");
        console.log('orderEntry', orderEntry);
        var isValid = helper.validateSecondScreen(component, event, helper);
    ...
    handleFaveValueChange: function(component, event, helper){
        console.log('handleFaveValueChange');
        var orderEntry = component.get("v.orderEntry");  
    ...
    handleCutOffChange: function(component, event, helper){
       // console.log("handleCutOffChange");
  	     var orderEntry = component.get("v.orderEntry");  
