({
    ...
    Savechanges :function(component, event, helper){
		...
		accountRecord = {};
		accountRecord["Id"] = component.get("v.accountId");
		accountRecord[checkbox.getAttribute('name')] = checkbox.checked;
            ...
            if(a.getState() == "ERROR"){
                ...
                if (errors) {                    
                    ...
                    if (errors[0] && errors[0].pageErrors && errors[0].pageErrors[0]){
						...
						accountRecord[checkbox.getAttribute('name')] = checkBoxOldVal;
