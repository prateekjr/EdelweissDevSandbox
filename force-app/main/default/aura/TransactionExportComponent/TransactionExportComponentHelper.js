({
   ...
   convertArrayOfObjectsToTXT : function(component,objectRecords){    
        // declare variables       
       ...
       if(component.find("SelectedValue").get("v.value") == 'Purchase/Redemption Direct' || component.find("SelectedValue").get("v.value") == 'Purchase/Redemption Normal'){
       ...
       } else if(component.find("SelectedValue").get("v.value") == 'Switch Direct' || component.find("SelectedValue").get("v.value") == 'Switch Normal'){
